function [y_true, y_flex] = bit_one_step(x0, tau_applied, unlock, w_piv, piv_flag,...
    ...
    sys_flex = @(y_flex, tau_app_flex, tau_flex) flex_propogate(a_flex, b_flex, tau_app_flex, tau_flex, y_flex);
...
%% sim
    ...
    for step = 1:num_steps
        ...
        k2 = sys(y_true + (k1/2), tau_applied, dw_piv) * dt;
        k3 = sys(y_true + (k2/2), tau_applied, dw_piv) * dt;
        k4 = sys(y_true + k3, tau_applied, dw_piv) * dt;
