...
## Generated on : Wed Jul 26 10:52:49 2023
...
PRODUCT = $(START_DIR)/libbitonestep
...
SRCS = $(START_DIR)/codegen/lib/libbitonestep/examples/main.c
...
LIBS = $(START_DIR)/codegen/lib/libbitonestep/libbitonestep.a
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(LIBS)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) $(OBJS) -Wl,--start-group $(LIBS) -Wl,--end-group $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
main.o : $(START_DIR)/codegen/lib/libbitonestep/examples/main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
