...
static real_T (*m_emlrt_marshallIn(const emlrtStack *sp, const mxArray *z_n,
...
static real_T (*o_emlrt_marshallIn(const emlrtStack *sp, const mxArray *C,
                                   const char_T *identifier))[9];
...
static uint16_T u_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                   const emlrtMsgIdentifier *msgId);
                                   ...
                                   const char_T *identifier))[18]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = l_emlrt_marshallIn(sp, emlrtAlias(x), &thisId);
  emlrtDestroyArray(&x);
  return y;
}
                                   ...
                                   const char_T *identifier))[27]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = n_emlrt_marshallIn(sp, emlrtAlias(z_n), &thisId);
                                   ...
                                   const char_T *identifier))[9]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = p_emlrt_marshallIn(sp, emlrtAlias(C), &thisId);
  emlrtDestroyArray(&C);
  return y;
}
                                    ...
                                    const mxArray **plhs)
{
  ...
  z_n = m_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "z_n");
  /* Invoke the target function */
                                ...
                                const mxArray **plhs)
{
  ...
  /* Marshall function inputs */
  z_n = m_emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "z_n");
...
void rot2axis_C_api(const mxArray *prhs, int32_T nlhs, const mxArray *plhs[2])
{
  ...
  /* Marshall function inputs */
  C = o_emlrt_marshallIn(&st, emlrtAlias(prhs), "C");
  /* Invoke the target function */
