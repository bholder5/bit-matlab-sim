function crl = gyro2_pitch()
    ...
    b.one.locx = 1160.237000;
    b.one.locy = 3861.333000;
    b.two.locx = 1166.839000;
    b.two.locy = 3866.417000;
    b.thr.locx = 1173.442000;
    b.thr.locy = 3871.501000;
    
    xp.one.locx = 1171.923000;
    xp.one.locy = 3859.814000;
    xp.two.locx = 1166.839000;
    xp.two.locy = 3866.417000;
    xp.thr.locx = 1161.755000;
    xp.thr.locy = 3873.020000;
    ...
    tab_y = readtable('/home/bholder/bit-matlab-sim/flexible_model_data/gyro2_p/wy.csv');
    col1y = tab_y(:,1);
    col2y = tab_y(:,2);
    col3y = tab_y(:,3);
