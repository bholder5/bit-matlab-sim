function crl = gyro2_xp()
    ...
    b.one.locx = 1114.480000;
    b.one.locy = 3920.907000;
    b.two.locx = 1121.083000;
    b.two.locy = 3925.991000;
    b.thr.locx = 1127.686000;
    b.thr.locy = 3931.075000;
    ...
    tab_x = readtable('/home/bholder/bit-matlab-sim/flexible_model_data/gyro2_xp/wx.csv');
    col1x = tab_x(:,1);
    col2x = tab_x(:,2);
    col3x = tab_x(:,3);
    
    tab_y = readtable('/home/bholder/bit-matlab-sim/flexible_model_data/gyro2_xp/wy.csv');
    col1y = tab_y(:,1);
    col2y = tab_y(:,2);
    col3y = tab_y(:,3);
    
    tab_z = readtable('/home/bholder/bit-matlab-sim/flexible_model_data/gyro2_xp/wz.csv');
    col1z = tab_z(:,1);
    col2z = tab_z(:,2);
    col3z = tab_z(:,3);
    ...
    set1x = table2array(col3x(1:ind, "Var3"));%P1
    ...
    scaled_diff_p_wxp = [deriv_p_wb(:,1)/dp(1), deriv_p_wb(:,2)/dp(2)];
    
    % calculate partial of deofrmation in p wrt xp
    deriv_b_wp = diff(w_z_b,1,2);
    scaled_diff_xp_wp = [deriv_b_wp(:,1)/vb1(1), deriv_b_wp(:,2)/vb2(1)];
    
    dfp_db = mean(scaled_diff_xp_wp,2)
    dfb_dp = mean(scaled_diff_p_wxp ,2)
