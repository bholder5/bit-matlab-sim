function crl = roll_bow()
    clear
    clc
    
%     addpath('/home/brad/bit-matlab-sim/flexible_model_data/roll_bow/')
    z.one.loc = -8.50600;
    z.two.loc = 0;
    z.thr.loc = 8.5063000;
    ...
    set1y = table2array(col3y(1:ind, "Var3"));%y2
    set2y = table2array(col3y(ind+1:2*ind, "Var3"));%z2
    set3y = table2array(col3y(2*ind+1:3*ind, "Var3"));%zc/y1
    set4y = table2array(col3y(3*ind+1:4*ind, "Var3"));%z1
    set5y = table2array(col3y(4*ind+1:5*ind, "Var3"));%yc
