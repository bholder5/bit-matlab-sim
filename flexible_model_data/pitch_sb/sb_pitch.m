function crl = sb_pitch()
    ...
    tab_x = readtable('/home/bholder/bit-matlab-sim/flexible_model_data/pitch_sb/wx.csv');
    col1x = tab_x(:,1);
    col2x = tab_x(:,2);
    col3x = tab_x(:,3);
    
    tab_y = readtable('/home/bholder/bit-matlab-sim/flexible_model_data/pitch_sb/wy.csv');
    col1y = tab_y(:,1);
    col2y = tab_y(:,2);
    col3y = tab_y(:,3);
